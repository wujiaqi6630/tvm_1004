...
/*!
 * \file dpu/default.h
 * \brief default dpu schedule
 */
#ifndef TOPI_DPU_DEFAULT_H_
#define TOPI_DPU_DEFAULT_H_
...
namespace dpu {
/*!
* \brief Helper to create a default dpu schedule for the given ops.
*
...
/*!
* \brief Create a default dpu schedule for the given ops.
*
* \param target The target to generate a schedule for.
* \param outs The output tensors.
*
...
/*!
* \brief Create a default dpu schedule for the given ops, with auto inline
*
* \param target The target to generate a schedule for.
* \param outs The output tensors.
*
