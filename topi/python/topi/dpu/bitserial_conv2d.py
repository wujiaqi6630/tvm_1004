...
@autotvm.register_topi_schedule(generic.nn.schedule_bitserial_conv2d_nchw, ['dpu'], 'direct')
@autotvm.register_topi_schedule(generic.nn.schedule_bitserial_conv2d_nhwc, ['dpu'], 'direct')
def schedule_bitserial_conv2d(cfg, outs):
    """DPU schedule for bitserial convolutions NCHW and NHWC"""
