...
class AttrFunctor<R(const ObjectRef& n, Args...)> {
 ...
 public:
  ...
  virtual R VisitAttr_(const ir::DivNode* op, Args... args) ATTR_FUNCTOR_DEFAULT;
	// wjq 2020/09/17
	virtual R VisitAttr_(const ir::PowNode* op, Args... args) ATTR_FUNCTOR_DEFAULT;
	// wjq 2020/09/17
...
class AttrsEqualHandler :
 ...
 protected:
  ...
  bool VisitAttr_(const ir::DivNode* lhs, const ObjectRef& other) final;
	// wjq 2020/09/17
	bool VisitAttr_(const ir::PowNode* lhs, const ObjectRef& other) final;
	// wjq 2020/09/17
...
class AttrsHashHandler :
 ...
 protected:
  ...
  size_t VisitAttr_(const ir::DivNode* op) final;
	// wjq 2020/09/17
	size_t VisitAttr_(const ir::PowNode* op) final;
	// wjq 2020/09/17
