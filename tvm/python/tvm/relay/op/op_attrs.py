...
@register_relay_attr_node
class LRN_sqrAttrs(Attrs):
    """Attributes for nn.lrn_sqr"""


@register_relay_attr_node
class LRN_powAttrs(Attrs):
    """Attributes for nn.lrn_pow"""


@register_relay_attr_node
class LRN_divAttrs(Attrs):
    """Attributes for nn.lrn_div"""

@register_relay_attr_node
class SoftmaxMaxAttrs(Attrs):
    """Attributes for nn.SoftmaxMax"""


@register_relay_attr_node
class SoftmaxSumAttrs(Attrs):
    """Attributes for nn.SoftmaxSum"""


@register_relay_attr_node
class SoftmaxDivAttrs(Attrs):
    """Attributes for nn.SoftmaxDiv"""
