...
def softmaxMax(data, axis=-1):
    return _make.softmaxMax(data, axis)

def softmaxSum(max_data, in_data, axis=-1):
    return _make.softmaxSum(max_data, in_data, axis)

def softmaxDiv(sum_data, max_data, in_data, axis=-1):
    return _make.softmaxDiv(sum_data, max_data, in_data,  axis)
...
def lrn_sqr(data, size=5, axis=1):
    return _make.lrn_sqr(data, size, axis)

def lrn_pow(sqr_data, size=5, axis=1, bias=2, alpha=.00001, beta=0.75):
    return _make.lrn_pow(sqr_data, size, axis, alpha, beta, bias)

def lrn_div(pow_data, in_data, axis=1):
    return _make.lrn_div(pow_data, in_data, axis)
