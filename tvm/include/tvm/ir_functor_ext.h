...
class ExprFunctor<R(const PrimExpr& n, Args...)> {
 ...
 public:
  ...
  virtual R VisitExpr_(const DivNode* op, Args... args) EXPR_FUNCTOR_DEFAULT;
	//wjq 2020/09/17
  virtual R VisitExpr_(const PowNode* op, Args... args) EXPR_FUNCTOR_DEFAULT;
	//wjq 2020/09/17
 ...
 private:
  ...
  static FType InitVTable() {
    ...
    IR_EXPR_FUNCTOR_DISPATCH(DivNode);
		//wjq 2020/09/17
		IR_EXPR_FUNCTOR_DISPATCH(PowNode);
		//wjq 2020/09/17
...
class TVM_DLL ExprVisitor :
 ...
 protected:
  ...
  void VisitExpr_(const DivNode* op) override;
	//wjq 2020/09/17
	void VisitExpr_(const PowNode* op) override;
	//wjq 2020/09/17
...
class TVM_DLL ExprMutator :
 ...
 protected:
  ...
  PrimExpr VisitExpr_(const DivNode* op) override;
	//wjq 2020/09/17
	PrimExpr VisitExpr_(const PowNode* op) override;
	//wjq 2020/09/17
