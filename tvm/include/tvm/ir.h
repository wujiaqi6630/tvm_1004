...
//wjq 2020/09/17
/*!
 * \brief pow(a, b) in the C semnatics.
 */
class PowNode : public BinaryOpNode<PowNode> {
 public:
  static constexpr const char* _type_key = "Pow";
};
//wjq 2020/09/17
...
/**********wjq**********/
/*! \brief DPU pragma */
constexpr const char* dpu_pragma = "#pragma ";
/**********wjq**********/
