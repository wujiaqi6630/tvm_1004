...
@tvm.target.generic_func
def schedule_softmaxMax(outs):
    return _default_schedule(outs, False)

@tvm.target.generic_func
def schedule_softmaxSum(outs):
    return _default_schedule(outs, False)

@tvm.target.generic_func
def schedule_softmaxDiv(outs):
    return _default_schedule(outs, False)
...
#@tvm.target.override_native_generic_func("schedule_bias_add")
@tvm.target.generic_func
def schedule_bias_add(outs):
    """Schedule for bias_add
    """
    return _default_schedule(outs, False)

#@tvm.target.override_native_generic_func("schedule_dropout")
@tvm.target.generic_func
...
@tvm.target.generic_func
def schedule_lrn_sqr(outs):
    return _default_schedule(outs, False)

@tvm.target.generic_func
def schedule_lrn_pow(outs):
    return _default_schedule(outs, False)

@tvm.target.generic_func
def schedule_lrn_div(outs):
    return _default_schedule(outs, False)
