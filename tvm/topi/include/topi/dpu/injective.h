...
/*!
 * \file dpu/injective.h
 * \brief dpu schedule for injective ops
 */
#ifndef TOPI_DPU_INJECTIVE_H_
#define TOPI_DPU_INJECTIVE_H_
...
/*!
* \brief Create an dpu schedule for the given injective ops.
*
