...
//wjq 2020/09/17 
/*
PrimExpr pow(PrimExpr a, PrimExpr b) {
  BinaryOpMatchTypes(a, b);
  PrimExpr ret = arith::TryConstFold<ir::PowNode>(a, b);
  if (ret.defined()) return ret;
  return ir::PowNode::make(a, b);
}
*/
//wjq 2020/09/17
...
PrimExpr pow(PrimExpr a, PrimExpr b) {
  BinaryOpMatchTypes(a, b);
	CHECK(a.dtype().is_float()) << "power only applies to float";
  PrimExpr ret = arith::TryConstFold<ir::PowNode>(a, b);
  if (ret.defined()) return ret;
  return ir::PowNode::make(a, b);
}
